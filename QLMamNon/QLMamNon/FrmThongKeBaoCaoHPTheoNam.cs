...
namespace QLMamNon
{
    public partial class FrmThongKeBaoCaoHPTheoNam : Form
    {
        NamHocBUL namHocbul;
        LopHocBUL lopHocbUL;
        ThongKeDoanhThuNamBUL thongKeDoanhThuNamBUL;

        public FrmThongKeBaoCaoHPTheoNam()
        {
        ...
        private void btnXemDSHS_Click(object sender, EventArgs e)
        {
            ...
            dgvThongKe.DataSource = thongKeDoanhThuNamBUL.layTatCaKhoanThuTrongNamHoc(maNamHoc);
        ...
        private void TaoChart(DataGridView dgvThongKe, string nameTitle, string seriesName)
        {
            try
            {
                ...
                {
                    string TenLop = dgvThongKe.Rows[i].Cells[2].Value?.ToString() ?? "";
                    string TienDaThu = dgvThongKe.Rows[i].Cells[4].Value?.ToString() ?? "";
                ...
                ChartThongKe.ChartAreas[0].AxisX.Title = dgvThongKe.Columns[2].HeaderText;
                ChartThongKe.ChartAreas[0].AxisY.Title = dgvThongKe.Columns[4].HeaderText;
            }
        ...
        private void bunifuButton21_Click(object sender, EventArgs e)
        {
            ...
            string maNamHoc = cboNamHoc.SelectedValue.ToString();
            DataTable dt = thongKeDoanhThuNamBUL.InDoanhThuHDTrongNam(maNamHoc, tenNamHoc);
            rptDoanhThuNam baoCao = new rptDoanhThuNam();
